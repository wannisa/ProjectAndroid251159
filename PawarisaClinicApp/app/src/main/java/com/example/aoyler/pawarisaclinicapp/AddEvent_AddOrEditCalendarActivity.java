...
public class AddEvent_AddOrEditCalendarActivity extends Activity implements View.OnClickListener{
    private String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.addevent_addcalendar);
    ...
    public void onSave(View view) {
        ...
        Intent t = new Intent(AddEvent_AddOrEditCalendarActivity.this, AddEvent_MainActivity.class);
        if (id != null) {
            t.putExtra("id", id);
        }
    ...
    public void onCancel(View view) {
        ...
        Intent intent = new Intent(AddEvent_AddOrEditCalendarActivity.this,AddEvent_MainActivity.class);
