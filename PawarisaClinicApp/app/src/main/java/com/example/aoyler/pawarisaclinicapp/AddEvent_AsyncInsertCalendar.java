 ...
 */
public class AddEvent_AsyncInsertCalendar extends AddEvent_CalendarAsyncTask {


    //    private final Calendar entry;
    AddEvent_Model name;
    AddEvent_AsyncInsertCalendar(AddEvent_MainActivity calendarSample, AddEvent_Model name) {
